...
@interface MASPhotoView () {
    
    BOOL _doubleTap;
    MASPhotoLoadingView *_photoLoadingView;
}
@property(nonatomic,strong)UIImageView *imageView;

@end

@implementation MASPhotoView
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if ((self = [super initWithFrame:frame])) {
        ...
        // 进度条
        _photoLoadingView = [[MASPhotoLoadingView alloc] init];
...
- (void)showImage {
    ...
    if (_photo.firstShow) { // 首次显示
        ...
        if (![_photo.url.absoluteString hasSuffix:@"gif"]) {
            ...
            __unsafe_unretained MASPhotoView *photoView = self;
            __unsafe_unretained MASPhoto *photo = _photo;
...
- (void)photoStartLoad
{
    if (_photo.image) {
        ...
        __unsafe_unretained MASPhotoView *photoView = self;
        __unsafe_unretained MASPhotoLoadingView *loading = _photoLoadingView;
        
        [_imageView yy_setImageWithURL:_photo.url
                           placeholder:_photo.srcImageView.image
                               options:YYWebImageOptionShowNetworkActivity |YYWebImageOptionIgnoreFailedURL
...
- (void)dealloc {
    // 取消请求
    [_imageView yy_setImageWithURL:[NSURL URLWithString:@"file:///abc"]
